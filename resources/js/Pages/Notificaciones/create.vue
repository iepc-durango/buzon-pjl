                ...
                <div v-if="selectedTipo?.tipo === 'Acuerdo'">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-5 sm:grid-cols-1">
                        <div>
                            ...
                            <textarea v-model="form.titulo" rows="8" @input="assertMaxChars('titulo', 516)" Required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"/>
                            Caracteres restantes: {{ 516 - form.titulo.length }}
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-5 sm:grid-cols-1">
                        <div class="mb-4">
                            ...
                            <textarea v-model="form.descripcion" rows="10" @input="assertMaxChars('descripcion', 696)" Required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"></textarea>
                            Caracteres restantes: {{ 696 - form.descripcion.length }}
                        </div>
                    </div>
